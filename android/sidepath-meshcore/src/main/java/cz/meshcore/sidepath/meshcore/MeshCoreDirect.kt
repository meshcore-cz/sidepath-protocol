 ...
 * incoming MeshCore DM carried opaquely over Sidepath can be decrypted on-device.
 *
 ...
 * and meshpkt `Identity.SharedSecret`. Crypto mirrors [cz.meshcore.sidepath.chat.ChatChannel].
 */

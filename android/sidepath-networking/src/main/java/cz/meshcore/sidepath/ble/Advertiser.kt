...
class SidepathAdvertiser(
    ...
    private fun startExtendedAdvertising(
        ...
        val data = AdvertiseData.Builder()
            .addServiceUuid(ParcelUuid(SidepathUUIDs.SERVICE))
            ...
            .addManufacturerData(SIDEPATH_MANUFACTURER_ID, nodeId.bytes)
